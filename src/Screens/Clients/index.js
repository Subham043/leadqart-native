...
const ClientsScreen = ({ navigation}) => {
    ...
    useEffect(() => {
        ...
        registerForPushNotificationsAsync().then(token => pNotificationHandler(token));
    ...
    const pNotificationHandler  = async(token) => {
        setExpoPushToken(token)
        const response = await axios.post('/pushNotification/create', {token}, {
            headers: {
