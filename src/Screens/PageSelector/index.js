...
const PagesScreen = ({ navigation, tabIndexNumber, leadId }) => {
        ...
        <View style={styles.container}>
            ...
            <ScrollView style={styles.ScrollContainer} refreshControl={<RefreshControl refreshing={refreshing} onRefresh={onRefresh} />} >
                ...
                searchData.map((item, index) => {
                    return (<PageSelectorCard name={item.title} id={item.id} image={item.image} description={item.description} navigation={navigation} key={index} leadId={leadId} />);
                }):
